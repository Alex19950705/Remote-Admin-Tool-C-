...
namespace Creeper.Controls.HexEditor
{
    public class Caret
    {
        ...
        public int SelectionStart
        {
            get
            {
                if (_endIndex < _startIndex) return _endIndex;
        ...
        public int SelectionLength
        {
            get
            {
                if (_endIndex < _startIndex) return _startIndex - _endIndex;
        ...
        public void SetStartIndex(int index)
        {
            ...
            if (SelectionStartChanged != null) SelectionStartChanged(this, EventArgs.Empty);

            if (SelectionLengthChanged != null) SelectionLengthChanged(this, EventArgs.Empty);
        }
